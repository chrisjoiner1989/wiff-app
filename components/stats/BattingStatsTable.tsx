          ...
          <tr className="border-b border-border">
            {COLUMNS.map((col) => (
              <th
                key={col.key}
                title={col.title}
                className={`px-2 py-2.5 text-[11px] font-medium tracking-wide uppercase text-muted-foreground ${
                  col.key === 'player_name'
        ...
        <tbody>
          {stats.map((row) => (
            ...
            >
              ...
              <td className="px-2 py-2.5 text-center font-mono tabular-nums text-sm">{row.ab}</td>
              <td className="px-2 py-2.5 text-center font-mono tabular-nums text-sm font-medium">{row.h}</td>
              <td className="px-2 py-2.5 text-center font-mono tabular-nums text-sm">{row['2b']}</td>
              <td className="px-2 py-2.5 text-center font-mono tabular-nums text-sm">{row['3b']}</td>
              <td className="px-2 py-2.5 text-center font-mono tabular-nums text-sm font-medium text-destructive">{row.hr}</td>
              <td className="px-2 py-2.5 text-center font-mono tabular-nums text-sm">{row.rbi}</td>
