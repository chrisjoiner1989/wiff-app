...
export default async function RootPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-neutral-950 text-white">
      ...
      <div className="relative min-h-screen flex flex-col px-6 py-8 md:py-10 max-w-md md:max-w-2xl mx-auto">
        {/* Top bar — wordmark + season chip */}
        ...
        {/* Hero */}
        <div className="flex-1 flex flex-col items-start justify-center gap-7 w-full py-10">
          {/* Welcome eyebrow */}
          ...
          <div className="space-y-4">
            ...
            <p className="text-[15px] md:text-base text-white/70 max-w-sm leading-relaxed">
              The scorebook your wiffle ball league has been waiting for.
              Score live from your phone. Stats keep themselves.
            </p>
          </div>

          {/* What you get — three crisp lines, broadcast-style */}
          <ul className="grid grid-cols-3 gap-px bg-white/10 w-full max-w-md rounded-md overflow-hidden">
            {[
              ...
              >
                ...
                <span className="text-[9.5px] text-white/55 font-bold uppercase tracking-[0.1em] text-center px-1">
                  {f.label}
                </span>
              </li>
            ))}
        ...
        <p className="mt-6 text-center text-[10px] uppercase tracking-[0.14em] font-bold text-white/35">
